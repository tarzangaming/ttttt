                    ...
                    {locationServicesData.services.map((service: any) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-2xl font-bold text-[#4a2c17] group-hover:text-[#c4841d] transition-colors leading-tight">
                                    {service.title}
                                </h3>
                            </div>

                            <div className="flex-grow">
                                <h4 className="text-lg font-semibold text-[#4a2c17] mb-4">
                            ...
                            <div className="mt-auto space-y-4">
                                <div
                                    className="block w-full text-center bg-[#c4841d] text-white font-bold py-4 rounded-xl hover:bg-[#8b5e14] transition-all shadow-md group-hover:shadow-lg relative z-20 pointer-events-none"
                                >
                                    {service.cta}
                                </div>
                                <div className="flex items-center justify-center gap-2 text-[#4a2c17] font-semibold relative z-20">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                    <a href={`tel:${phone.replace(/\D/g, '')}`} className="hover:text-[#c4841d] transition-colors">
                                        {phone}
                                    </a>
                                </div>
                            </div>
