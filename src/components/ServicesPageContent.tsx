...
export default function ServicesPageContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white px-6 max-w-6xl mx-auto">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="mb-6">
                <span className="bg-[#d97706] text-white px-6 py-3 rounded-full text-sm font-semibold animate-pulse">
                  Licensed & Insured
                </span>
              </div>
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="group relative bg-white text-[#1e3a5f] font-bold px-8 py-4 rounded-xl text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl inline-flex items-center gap-3"
                >
                  <div className="relative">
                    <svg className="w-6 h-6 animate-bounce text-[#1e3a5f]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" />
                    </svg>
                  </div>
                  <span className="font-bold tracking-wide">(866) 289-1750</span>
                </a>
              </div>
            </div>
          </div>
      ...
      {/* Stats Section */}
      <section className="py-20 px-4 bg-gray-50 text-[#1e3a5f]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="text-4xl md:text-5xl font-bold mb-2 text-[#d97706]">{currentServices}+</div>
                <div className="text-lg font-medium">Specialized Services</div>
              </div>
            </div>
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="text-4xl md:text-5xl font-bold mb-2 text-[#d97706]">{currentExperience}+</div>
                <div className="text-lg font-medium">Years Experience</div>
              </div>
            </div>
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="text-4xl md:text-5xl font-bold mb-2 text-[#d97706]">{currentResponse}</div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#1e3a5f] mb-4">Our Complete Construction & Roofing Services</h2>
                ...
                <Link key={service.slug} href={`/services/${service.slug}`} className="group">
                  <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden h-full flex flex-col border border-gray-100">
                    <div className="relative h-48 overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[#1e3a5f] shadow-sm">
                        {service.category}
                      </div>
                    </div>
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="mt-auto flex items-center text-[#d97706] font-bold">
                        Learn More
      ...
      <section className="py-20 px-4 bg-[#1e3a5f] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <a
              href="tel:+18662891750"
              className="inline-flex items-center bg-[#d97706] text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-[#b45309] transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
