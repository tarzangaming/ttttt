    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left text-white">
              ...
              <p className="text-base sm:text-lg mb-6 opacity-80 leading-relaxed">
                At Bennett Construction & Roofing, we&apos;ve been protecting homes and businesses in {location.name}, {location.state} for over 25 years.
            ...
            <div className="hidden lg:block">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                <h3 className="text-white text-2xl font-bold mb-6 text-center">Why Choose Bennett?</h3>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-[#1e3a5f]">
            Why {location.name} Homeowners Choose Bennett Construction
          </h2>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Why Choose Bennett Construction & Roofing in {location.name}?
          </h2>
