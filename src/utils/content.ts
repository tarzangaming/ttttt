...
function generateVirtualStateLocation(slug: string, stateCode: string): Location {
  ...
  return {
    ...
    meta: {
      title: `Top Rated Roofing Company in ${stateName} | Bennett Construction`,
...
export function generateLocalBusinessCitySchema(
  ...
  return {
    ...template,
    name: `Bennett Construction & Roofing - ${cityName}`,
    url: `https://${subdomain}.bennettconstructionandroofing.com`,
    address: {
      '@type': 'PostalAddress',
