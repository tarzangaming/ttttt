...
export function buildIntroContent(input: HeroSubtextInput) {
    ...
    const introParagraphs = [
        `When you need reliable ${serviceName.toLowerCase()} in ${city}, trust the experts at Dolimiti Steel Roofing. We bring over 25 years of experience to every project, ensuring quality workmanship and superior customer service.`,
