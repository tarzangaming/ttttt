            ...
            <section className="py-20 px-4 max-w-5xl mx-auto">
                ...
                <div className="mt-16 bg-blue-50/50 p-8 rounded-2xl border border-blue-100">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        At <strong>Bennett Construction</strong>, we use only synthetic underlayment and high-grade sealants rated for desert conditions, ensuring your {service.title.toLowerCase()} investment lasts 25+ years, not just 5.
                    </p>
                </div>
            </section>
