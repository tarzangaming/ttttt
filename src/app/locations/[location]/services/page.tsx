        ...
        <div className="relative max-w-5xl mx-auto text-center text-white z-10">
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="bg-[#c4841d] hover:bg-[#8b5e14] text-white font-bold px-8 py-3 rounded-lg transition-colors flex items-center gap-2"
            >
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#c4841d] font-semibold text-sm uppercase tracking-wider">{rp(servicesContent.gridLabel)}</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#4a2c17] mt-2 mb-4">
              ...
              return (
                <Link key={service.slug} href={`/locations/${safeLocation.id}/${service.slug}`} className="block group h-full">
                  <div className="relative h-[400px] w-full rounded-2xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group">
                    ...
                    {/* Gradient Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-t from-[#4a2c17]/95 via-[#4a2c17]/70 to-transparent group-hover:via-[#4a2c17]/60 transition-all duration-500" />
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-end">
                      <div className="transform transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                        ...
                        <div className="flex items-center text-[#c4841d] font-bold tracking-wide text-sm uppercase group-hover:text-white transition-colors duration-300">
                          <span className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full group-hover:bg-[#c4841d] transition-all duration-300">
                            Learn More →
                          </span>
                        </div>
                      </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`tel:${safeLocation.phone.replace(/\D/g, '')}`}
              className="inline-flex items-center justify-center bg-[#c4841d] hover:bg-[#8b5e14] text-white font-bold px-8 py-4 rounded-lg text-lg transition"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-white text-[#4a2c17] font-bold px-8 py-4 rounded-lg text-lg hover:bg-gray-100 transition"
            >
