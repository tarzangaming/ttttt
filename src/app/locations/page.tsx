      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/locations" className="text-[#c4841d] font-bold hover:underline mt-4 inline-block">View All Locations</Link>
          </div>
        </div>
      );
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#4a2c17]/80 to-[#2d1a0e]/60" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center text-white">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
            America&apos;s Premier <span className="text-[#c4841d]">{locContent.hero.titleHighlight}</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-[#c4841d] hover:bg-[#8b5e14] text-white font-bold px-8 py-5 rounded-xl text-lg transition shadow-xl flex items-center justify-center gap-3"
            >
            ...
            <Link
              href="#locations"
              className="bg-white text-[#4a2c17] hover:bg-gray-100 font-bold px-8 py-5 rounded-xl text-lg transition shadow-xl block"
            >
              Find Your City
            </Link>
          </div>
      ...
      <section id="locations" className="py-20 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#4a2c17] mb-6">{locContent.areasTitle}</h2>
        ...
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-[#4a2c17] mb-8 border-b pb-4">{locContent.statesTitle}</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {getAllStates().map((state) => (
              ...
              >
                <span className="font-medium text-gray-700 group-hover:text-[#c4841d] transition-colors text-sm truncate">{state.name}</span>
              </Link>
            ))}
          </div>
        </div>
        ...
        {featuredLocations.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredLocations.map((location) => (
              ...
              >
                <div className="h-3 bg-[#c4841d] group-hover:h-4 transition-all" />
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-[#4a2c17]">{location.name}</h3>
                    <span className="text-[#c4841d] text-xl group-hover:translate-x-1 transition-transform">&rarr;</span>
                  </div>
                  <p className="text-gray-600 mb-6">
                    Professional roofing services for {location.name} and surrounding neighborhoods like {location.areas?.slice(0, 3).join(', ')}.
                  </p>
                  <span className="text-sm font-bold text-[#4a2c17] uppercase tracking-wide group-hover:text-[#c4841d] transition-colors">
                    View Local Services
                  </span>
                </div>
              </Link>
          ...
          <div className="text-center p-8 bg-white rounded-xl shadow border border-gray-200">
            <p className="text-xl text-gray-600">
              ...
              <br />
              <a href={`tel:${phoneClean}`} className="text-[#c4841d] font-bold hover:underline">Call us to confirm coverage in your area.</a>
            </p>
          </div>
        )}
      </section>
      ...
      {/* Value Prop */}
      <section className="bg-[#4a2c17] text-white py-20 px-4">
              ...
              <ul className="space-y-4 text-lg">
                {locContent.valueProp.items.map((item, i) => (
                  <li key={i} className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#c4841d] flex items-center justify-center font-bold">&#10003;</div>
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <section className="py-20 px-4 bg-gray-50 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-[#4a2c17] mb-6">{locContent.cta.title}</h2>
          <p className="text-gray-600 text-xl mb-10">
            {r(locContent.cta.subtitle)}
          </p>
          <a
            href={`tel:${phoneClean}`}
            className="inline-flex items-center bg-[#c4841d] hover:bg-[#8b5e14] text-white font-bold px-10 py-5 rounded-full text-xl transition shadow-xl"
          >
