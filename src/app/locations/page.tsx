...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!seo) {
    return {
      ...
      description: "Dolimiti Steel Roofing is America's premier licensed contractor.",
      alternates: { canonical: 'https://dolimitisteelroofing.com/locations' },
    };
  }
  return {
    title: seo.title,
      ...
      <section className="bg-[#1e3a5f] text-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-6">Why America Chooses Dolimiti</h2>
      ...
      <section className="py-20 px-4 bg-gray-50 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-xl mb-10">
            Schedule a free inspection with your local Dolimiti Steel Roofing team. We are in your neighborhood.
          </p>
          <a
            href="tel:8662891750"
