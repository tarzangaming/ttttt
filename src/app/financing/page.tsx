...
export default function FinancingPage() {
    return (
        <div className="bg-white font-sans text-gray-900">
            ...
            {/* 1. HERO */}
            <section className="relative py-24 px-4 bg-[#1e3a5f] text-white flex items-center justify-center min-h-[60vh] overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl md:text-7xl font-extrabold mb-6">
                        ...
                        <span className="block text-[#d97706] mt-2">Pay Over Time</span>
                    </h1>
                    <p className="text-xl opacity-90 mb-10 font-light">
                        Don&apos;t let budget stop you from protecting your home. Flexible payment plans starting at <strong className="text-white border-b-2 border-[#d97706]">$149/mo</strong>.
                    </p>
                    <a
                        href="#options"
                        className="bg-[#d97706] hover:bg-[#b45309] text-white font-bold px-10 py-5 rounded-xl text-lg transition shadow-xl inline-block"
                    >
            ...
            <section className="py-20 px-4 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">Why Finance Your Project?</h2>
            ...
            {/* 3. FINANCING OPTIONS */}
            <section id="options" className="py-20 bg-[#1e3a5f] px-4">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-2xl relative overflow-hidden transform hover:-translate-y-2 transition duration-300">
                            <div className="absolute top-0 right-0 bg-[#d97706] text-white text-xs font-bold px-3 py-1 uppercase rounded-bl-lg">Most Popular</div>
                            <h3 className="text-2xl font-bold text-[#1e3a5f] mb-2">Same-As-Cash</h3>
                            <div className="text-5xl font-extrabold text-[#d97706] mb-4">0% <span className="text-lg text-gray-400 font-normal">APR</span></div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-2xl transform hover:-translate-y-2 transition duration-300">
                            <h3 className="text-2xl font-bold text-[#1e3a5f] mb-2">Low Monthly Payment</h3>
                            <div className="text-5xl font-extrabold text-[#d97706] mb-4">5.99% <span className="text-lg text-gray-400 font-normal">Fixed APR</span></div>
            ...
            <section className="py-20 px-4 max-w-3xl mx-auto">
                <h2 className="text-3xl font-bold text-[#1e3a5f] mb-8 text-center">Financing FAQs</h2>
                <div className="space-y-6">
                    <div>
                        <h4 className="font-bold text-[#1e3a5f] mb-2">Does applying affect my credit score?</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-[#1e3a5f] mb-2">What if I have bad credit?</h4>
